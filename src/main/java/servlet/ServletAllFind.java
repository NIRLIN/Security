...
@WebServlet("/servlet/ServletAllFind")
public class ServletAllFind extends javax.servlet.http.HttpServlet {
...
//        out.println("iuhiu");
        ...
        request.getRequestDispatcher("../user/page/security-list.jsp").forward(request, response);//转发请求
