...
@WebServlet("/servlet/ServletFindDealSecurityInfo")
public class ServletFindDealSecurityInfo extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("../user/page/deals_information.jsp").forward(request, response);
